    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('online', 'Online'), ('offline', 'Offline'), ('lunch', 'Lunch Break'), ('vacation', 'Vacation')], default='offline', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.CharField(default='XYHijSFEeHK8ypQ9jRU5jlFetVLGQg2hUSH2UkNpdbI', max_length=64, unique=True)),
